...
$pdf->setXY(124,54);
$pdf->MultiCell(12,3,"LAMA INAP",0,'C');

$pdf->setXY(5,52);
$pdf->Cell(7,10,"NO",1,0,'C');
$pdf->Cell(32,10,"KODE BARANG",1,0,'C');
$pdf->Cell(80,10,"NAMA BARANG",1,0,'C');
$pdf->Cell(12,10,"",1,0,'C');
$pdf->Cell(15,10,"QTY",1,0,'C');
$pdf->Cell(12,10,"CBM",1,0,'C');
$pdf->Cell(20,10,"HANDLING",1,0,'C');
...
while ($d1=mysqli_fetch_array($h1))
{
	...
	$tgl_keluar = strtotime($d1['tgl_sj']);
	...
	$pdf->setXY(5,$y);
	$pdf->Cell(7,$tinggi,"$n.",1,0,'C');
	$pdf->Cell(32,$tinggi,"$d1[kode]",1,0,'C');
	$pdf->Cell(80,$tinggi,"",1,0,'L');	
	$pdf->Cell(12,$tinggi,"$aging",1,0,'C');
	$pdf->Cell(15,$tinggi,"$d1[keluar] $d1[unit]",1,0,'C');
	$pdf->Cell(12,$tinggi,"$volx",1,0,'C');
	$pdf->Cell(20,$tinggi,"$hargax",1,0,'R');
	$pdf->Cell(22,$tinggi,"$jumlahx",1,1,'R');
