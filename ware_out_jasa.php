...
{		
	...
	if($mode == 'Add' )
	{
		...
		$sql = "INSERT INTO  t_ware_data (jenis, tanggal, no_doc, id_cust, jenis_sj, gudang, id_mobil, id_supir, no_polisi, supir, telp, ket, created, no_do, jasa, id_quo, no_ref) values
				('1', '$tgl_sjx', '$no_sj',  '$id_cust', '$jenis_sj', '$gudang', '$id_mobil', '$id_supir', '$no_polisi', '$supir', '$telp','$ket', '$id_user', '$no_do', '1', '$id_quo', '$no_ref')";
	...
	header("Location: ware_out_jasa.php?id=$xy1");
}
else
{	
	$idx = $_GET['id'];	
  ...
  <head>
	...
	<script>
		...
		function ReadData() {	
			...
			$.get("ajax/ware_crud.php", {mode:mode,id_data:id_data, type:"Read_Jasa_Biaya" }, function (data, status) {
		...
		function TampilBiaya(){	
			...
			$.get("ajax/ware_crud.php", {id_quo:id_quo, type:"ListBiaya_Quo" }, function (data, status) {
				$(".tampil_biaya").html(data);
			});
  ...
  <body class="hold-transition skin-blue sidebar-mini sidebar-collapse" onload="initMap()">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper" style="min-height:750px">
			...
			<div class="col-md-6" >
				<div class="box box-success box-solid" style="padding:5px;border:1px solid #ccc;height:265px">					
			...
			<div class="col-md-6" >
				<div class="box box-success box-solid" style="padding:5px;border:1px solid #ccc;height:265px">					
					...
					<div style="width:100%;" class="input-group">
						...
						style="resize:none;width: 80%; height: 140px; font-size: 11px; line-height: 12px; 
			...
			<?php if($mode != 'Add'){?>	
				<div class="col-md-12" style="width:99%;border:0px solid #ddd;padding:5px">					
					<div style="width:99%;border-bottom:2px solid #83a939;background:none;margin-left:-5px;margin-top:-5px;margin-bottom:-9px" class="input-group">	
						...
						<div id="tabs5" >
							<ul> 
								<li id="current"><?php echo "<a href=$link1>"; ?><span><b>Data SO</b></span></a></li> 
								<li ><?php echo "<a href=$link2>"; ?><span><b>Data SJ</b></span></a></li>
							</ul>
						</div>	
					</div>
			...
			<div class="col-md-12" >
				...
				<?php if($mode != 'Add' ){?>
					<button class="btn btn-block btn-warning" 
						...
						onClick="window.open('cetak_inv_jasa.php?id=<?php echo $idx;?>','blank')" >
			...
			<div class="modal-content" style="background: none">
				<div class="modal-body">
					<div class="col-md-12" style="min-height:40px;border:0px solid #ddd;padding:0px;border-radius:5px;">
						<div class="box box-success box-solid" style="padding:5px;border:1px solid #ccc">	
							<div class="small-box bg" style="font-size:12px;font-family: 'Arial';color :#fff;margin:0px;background-color:#4783b7;text-align:left;padding:5px;margin-bottom:1px">							
								&nbsp;&nbsp;<b><i class="fa fa-list"></i>&nbsp;Data Biaya Quotation</b>
							</div>	
							<br>
							<div style="width:100%;" class="input-group">
								<span class="input-group-addon" style="text-align:right;background:none;min-width:150px"><b>Nama Biaya :</b></span>
								<input type="text"  id ="nama_biaya"  style="text-align: left;width:70%" readonly  >
								...
								<button class="btn btn-block btn-primary" id="cost"
									...
									onClick="javascript:TampilBiaya()">
									<span class="glyphicon glyphicon-search"></span>
								</button>	
								</div>
							...
							<div style="width:100%;" class="input-group">
								...
								<input type="text" id="harga" value="" style="text-align: right;width:20%;border:1px solid rgb(169, 169, 169)"
			...
			<div class="modal-content" style="background: none">	
				<div class="modal-body">						
					<div class="col-md-12" style="min-height:40px;border:0px solid #ddd;padding:0px;border-radius:5px;">
						<div class="box box-success box-solid" style="padding:5px;border:1px solid #ccc">	
							<div class="small-box bg" style="font-size:12px;font-family: 'Arial';color :#fff;margin:0px;background-color:#4783b7;text-align:left;padding:5px;margin-bottom:1px">							
								&nbsp;&nbsp;<b><i class="fa fa-list"></i>&nbsp;Data Biaya</b>
							</div>		
							<div class="table-responsive mailbox-messages" >									
								<div class="tampil_biaya"></div>
							</div>
							<br>
						</div>
					</div>								
