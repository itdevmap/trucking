	...
	<script>
		...
		function ReadData(hal) 
		{
			...
			$.get("ajax/ware_crud.php", {
				...
				cari1:cari1,
				hal:hal,
				type:"Read_Barang" }, function (data, status) {
		...
		{			
			...
			var field1 = $("#field1").val();
			var cari1 = $("#search_name1").val();
			var id = field+'|'+cari+'|'+field1+'|'+cari1;
			var idx = btoa(id);
			var win = window.open('ware_excel.php?id='+idx);
		}
		function DownloadData(id) 
		{			
			var idx = btoa(id);
			var win = window.open('ware_stok_excel.php?id='+idx);
		}
	</script>	
			...
			<div class="col-md-12" style="width:99%;border:0px solid #ddd;padding:5px">					
				<div style="width:99%;border-bottom:2px solid #83a939;background:none;margin-left:-5px;margin-top:-5px;margin-bottom:-9px" class="input-group">	
						<?php
							...
							$link2 = "ware_barang.php?id=$xy1";
						?>
					<div id="tabs5" >
						<ul> 
							<li ><?php echo "<a href=$link1>"; ?><span><b>Data Quotation </b></span></a></li> 
							<li id="current"><?php echo "<a href=$link2>"; ?><span><b>Data Stock Barang</b></span></a></li>
						</ul>
					</div>	
				</div>					
			</div>	
					...
					<div class="col-md-12" style="min-height:40px;border:0px solid #ddd;padding:0px;border-radius:5px;">
						<div class="box box-success box-solid" style="padding:5px;border:1px solid #ccc">	
							...
							<div style="width:100%;" class="input-group">
								...
								<input type="text"  id ="nama_cust"  style="text-align: left;width:75%" readonly  >
							...
							<div style="width:100%;" class="input-group">
								...
								text-align: left;width:45%;border:1px solid rgb(169, 169, 169)" />	
							...
							<div style="width:100%;" class="input-group">
								<span class="input-group-addon" style="text-align:right;background:none;min-width:150px"><b>Aging :</b></span>
								<input type="text" id="aging"  onkeypress="return isNumber(event)"  value="" style="text-align: center;width:15%;border:1px solid rgb(169, 169, 169)" />	Days
							</div> 
							<div style="width:100%;" class="input-group">
