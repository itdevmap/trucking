	...
	<script>
        // ----------------- READ DATA -----------------
            ...
            function ReadData(hal) {
                ...
                $.get("ajax/route_crud.php", {paging:paging,cari:cari,hal:hal, type:"Read" }, function (data, status) {
                    ...
                    <div class="col-md-12" style="min-height:40px;border:0px solid #ddd;padding:0px;border-radius:5px;">
                        <div class="box box-success box-solid" style="padding:5px;border:1px solid #ccc">	
                            ...
                            <div style="width:100%;" class="input-group">
                                ...
                                <select id="vendor" style="width: 80%;">
                                    <option value="" hidden></option>
                                    <?php
                                    $tampil1="SELECT * FROM m_vendor_tr WHERE STATUS ='1' ORDER BY nama_vendor";
                                    $hasil1=mysqli_query($koneksi, $tampil1);       
                                    while ($data1=mysqli_fetch_array($hasil1)){?>
                            ...
                            <div style="width:100%;" class="input-group">
                                ...
                                <select id="origin" style="width: 80%;">
                                    <option value="" hidden></option>
                                    <?php
                                    $tampil1="SELECT * FROM m_kota_tr WHERE STATUS ='1' ORDER BY nama_kota";
                                    $hasil1=mysqli_query($koneksi, $tampil1);       
                                    while ($data1=mysqli_fetch_array($hasil1)){?>
                            ...
                            <div style="width:100%;" class="input-group">
                                ...
                                <select id="destination" style="width: 80%;">
                                    <option value="" hidden></option>
                                    <?php
                                    $tampil1="SELECT * FROM m_kota_tr WHERE STATUS ='1' ORDER BY nama_kota";
                                    $hasil1=mysqli_query($koneksi, $tampil1);       
                            ...
                            <div style="width:100%;" class="input-group">
                                ...
                                <input type="text" id="cost" value="" style="text-align: right;width:40%;" 
