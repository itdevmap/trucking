...
{		
	...
	if($mode == 'Add' )
	{
		...
		$sql = "INSERT INTO  t_ware_quo (quo_date, quo_no, id_cust, ket, created, sales, max_cbm, aging_sewa, harga_sewa, harga_handling, no_kontrak) values
				('$quo_datex', '$quo_no', '$id_cust', '$ket', '$id_user', '$sales' , '$max_cbm', '$aging_sewa', '$harga_sewa', '$harga_handling', '$no_kontrak')";
