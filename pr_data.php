		...
		function TampilData(jenis) {
			...
			$.post("ajax/pr_crud.php", {
				...
				if (jenis === "route") {
					...
					$("#form-item").show();
					$("#uom").val('PCS').prop("readonly", true);
					$("#ket").html('UoM :');
				} 
				...
				<div class="col-md-6" >
					<div class="box box-success box-solid" style="padding:5px;border:1px solid #ccc; min-height:190px">					
						...
						<div style="width:100%;" class="input-group">
                            ...
                            <button class="btn btn-block btn-primary" id="po" style="padding:6px 12px;margin-top:-3px;border-radius:2px;margin-left:2px" type="button" onClick="javascript:TampilSQ()">
