...
<html>
  <head>
	...
	<script>	
		...
		function ReadData(hal) {
			var tahun = $("#tahun").val();
			$.get("ajax/pendapatan_crud.php", {tahun:tahun,  type:"read_hand" }, function (data, status) {
		...
		function Download() 
		{
			var tahun = $("#tahun").val();
			var idx = btoa(tahun);
			var win = window.open('pend_hand_excel.php?id='+idx);
		}
    </script>
  ...
  <body class="hold-transition skin-blue sidebar-mini sidebar-collapse" onload="initMap()">
	...
	<div class="wrapper">
		...
		<form method="post" name ="myform" action="pend_hand.php?action=cari" class="form-horizontal" > 
				...
				<div style="width:99%;border-bottom:2px solid #83a939;background:none;margin-left:-5px;margin-top:-5px;margin-bottom:-9px" class="input-group">	
					...
					<div id="tabs5" >
						<ul> 
							...
							<li id="current"><?php echo "<a href=$link2>"; ?><span><b>Handling</b></span></a></li>
							<li ><?php echo "<a href=$link3>"; ?><span><b>Sewa</b></span></a></li>
						</ul>
					</div>	
				</div>					
			</div>	
