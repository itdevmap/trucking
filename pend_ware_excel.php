...
header("Content-Disposition: attachment; filename=CROSSDOCKING.xls");
...
<table border="0">
	<tr>
		<th colspan="7" style="font-size:24;text-align:left">PENDAPATAN CROSSDOCKING </th>
	</tr>
	<tr>
...
<table border="1">
	...
	<?php
	$t1 = "select t_ware_data.*, m_cust_tr.nama_cust from
