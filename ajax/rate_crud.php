...
if ($_GET['type'] == "Read")
{
	...
	$data = '<table class="table table-hover table-striped" style="width:100%">
			<thead style="font-weight:500px !important">
				<tr>					
					...
					<th rowspan="2" width="25%" style="text-align: center;">ASAL</th>
					<th rowspan="2" width="25%" style="text-align: center;">TUJUAN</th>
					<th rowspan="2" width="10%" style="text-align: center;">JENIS MOBIL</th>
					<th rowspan="2" width="7%" style="text-align: center;">RATE</th>
					<th rowspan="2" width="7%" style="text-align: center;">UANG JALAN</th>
					<th rowspan="2" width="7%" style="text-align: center;">KOMISI SUPIR</th>
	...
	{	
		...
		if($mode == 'Add')
		{			
			$sql = "INSERT INTO m_rate_tr (id_asal, id_tujuan, jenis_mobil, rate, uj, komisi, status, created) values
					('$id_asal','$id_tujuan','$jenis_mobil', '$rate', '$uj', '$komisi', '1', '$id_user')";
