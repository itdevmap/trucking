	...
	$data = '<table class="table table-hover table-striped" style="width:100%">
			<thead style="font-weight:500px !important">
				<tr>					
					...
					<th rowspan="2" width="11%" style="text-align: center;">ASAL</th>
					<th rowspan="2" width="11%" style="text-align: center;">TUJUAN</th>
					<th rowspan="2" width="6%" style="text-align: center;">JENIS</th>
					<th rowspan="2" width="6%" style="text-align: center;">HARGA</th>
...
}else if($_GET['type'] == "Read_Detil")
{
	...
	$data = '<table class="table table-hover table-striped" style="width:100%">
			<thead style="font-weight:500px !important">
				<tr>	
					<th rowspan="2" width="3%" style="text-align: center;">NO</th>					
					<th rowspan="2" width="31%" style="text-align: center;">ASAL</th>
					<th rowspan="2" width="31%" style="text-align: center;">TUJUAN</th>
					<th rowspan="2" width="20%" style="text-align: center;">JENIS</th>
					<th rowspan="2" width="9%" style="text-align: center;">BIAYA KIRIM</th>
