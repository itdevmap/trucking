...
$pq = mysqli_query($koneksi,"select * from m_role_akses_tr where id_role = '$id_role'  and id_menu ='21' ");
  ...
  <head>
	...
	<script>
		...
		function ReadData(hal) {
			...
			$.get("ajax/rate_crud.php", {paging:paging,cari1:cari1, cari2:cari2, field1:field1, field2:field2, hal:hal, type:"Read" }, function (data, status) {
		...
		function GetData(id) {
			...
			$.post("ajax/rate_crud.php", {
				...
				function (data, status) {
					...
					$("#komisi").val(Desimal(data.komisi));
  ...
  <body class="hold-transition skin-blue sidebar-mini sidebar-collapse" onload="initMap()">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper" style="min-height:750px">
			<br>
			<ol class="breadcrumb">
				<li><h1><i class="fa fa-list"></i><font size="4">&nbsp;&nbsp;<b>Data Harga FCL</b></font></h1></li>					
			</ol>
			<br>
			<div class="col-md-12" style="width:99%;border:0px solid #ddd;padding:5px">					
					<div style="width:99%;border-bottom:2px solid #83a939;background:none;margin-left:-5px;margin-top:-5px;margin-bottom:-9px" class="input-group">	
						...
						$link1 = "rate.php?id=$xy1";
						$link2 = "rate_lcl.php?id=$xy1";
						?>
						<div id="tabs5" >
							<ul> 
								<li id="current"><?php echo "<a href=$link1>"; ?><span><b>FCL</b></span></a></li> 
								<li ><?php echo "<a href=$link2>"; ?><span><b>LCL</b></span></a></li>
							</ul>
						</div>	
					</div>
				...
				<div class="modal-body">	
					<div class="col-md-12" style="min-height:40px;border:0px solid #ddd;padding:0px;border-radius:5px;">
						<div class="box box-success box-solid" style="padding:5px;border:1px solid #ccc">	
							...
							<div style="width:100%;" class="input-group">
								<span class="input-group-addon" style="text-align:right;background:none;min-width:150px"><b>Komisi Supir :</b></span>								
								<input type="text" id="komisi" value="" style="text-align: right;width:20%;" 
								onBlur ="this.value=Desimal(this.value);" onkeypress="return isNumber(event)"  >
							</div>
							<div style="width:100%;" class="input-group">
