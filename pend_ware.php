...
<html>
  <head>
	...
	<script>	
		...
		function ReadData(hal) {
			var tahun = $("#tahun").val();
			$.get("ajax/pendapatan_crud.php", {tahun:tahun,  type:"read_dock" }, function (data, status) {
		...
		function Download() 
		{
			var tahun = $("#tahun").val();
			var idx = btoa(tahun);
			var win = window.open('pend_ware_excel.php?id='+idx);
		}	
    </script>
  ...
  <body class="hold-transition skin-blue sidebar-mini sidebar-collapse" onload="initMap()">
	...
	<div class="wrapper">
		...
		<form method="post" name ="myform" action="pend_ware.php?action=cari" class="form-horizontal" > 
		<div class="content-wrapper" style="min-height:750px">
			...
			<div class="col-md-12" style="width:99%;border:0px solid #ddd;padding:5px">					
				<div style="width:99%;border-bottom:2px solid #83a939;background:none;margin-left:-5px;margin-top:-5px;margin-bottom:-9px" class="input-group">	
					...
					<div id="tabs5" >
						<ul> 
							<li id="current"><?php echo "<a href=$link1>"; ?><span><b>Crossdocking</b></span></a></li> 
