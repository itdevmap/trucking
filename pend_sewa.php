...
$pq = mysqli_query($koneksi, "select * from m_role_akses_tr where id_role = '$id_role'  and id_menu ='31' ");
...
<html>
  <head>
	...
	<script>	
		...
		function ReadData(hal) {
			var tahun = $("#tahun").val();
			$.get("ajax/pendapatan_crud.php", {tahun:tahun,  type:"read_sewa" }, function (data, status) {
		...
		function Download() 
		{
			var tahun = $("#tahun").val();
			var idx = btoa(tahun);
			var win = window.open('pend_sewa_excel.php?id='+idx);
		}
    </script>
  ...
  <body class="hold-transition skin-blue sidebar-mini sidebar-collapse" onload="initMap()">
	...
	<div class="wrapper">
		...
		<form method="post" name ="myform" action="pend_sewa.php?action=cari" class="form-horizontal" > 
		<div class="content-wrapper" style="min-height:750px">
			...
			<div class="col-md-12" style="width:99%;border:0px solid #ddd;padding:5px">					
				<div style="width:99%;border-bottom:2px solid #83a939;background:none;margin-left:-5px;margin-top:-5px;margin-bottom:-9px" class="input-group">	
						<?php
							$link1 = "pend_ware.php?id=$xy1";
							$link2 = "pend_hand.php?id=$xy1";
							$link3 = "pend_sewa.php?id=$xy1";
						?>
					<div id="tabs5" >
						<ul> 
							<li ><?php echo "<a href=$link1>"; ?><span><b>Crossdocking</b></span></a></li> 
							<li ><?php echo "<a href=$link2>"; ?><span><b>Handling</b></span></a></li>
							<li id="current"><?php echo "<a href=$link3>"; ?><span><b>Sewa</b></span></a></li>
						</ul>
					</div>	
				</div>					
			</div>	
