...
$pq = mysqli_query($koneksi, "select * from m_role_akses_tr where id_role = '$id_role'  and id_menu ='30' ");
...
<html>
  <head>
	...
	<script>	
		...
		function ReadData(hal) {
			var tahun = $("#tahun").val();
			$.get("ajax/pendapatan_crud.php", {tahun:tahun,  type:"read_truck" }, function (data, status) {
		...
		function Download() 
		{
			var tahun = $("#tahun").val();
			var idx = btoa(tahun);
			var win = window.open('pend_truck_excel.php?id='+idx);
		}	
    </script>
  ...
  <body class="hold-transition skin-blue sidebar-mini sidebar-collapse" onload="initMap()">
	...
	<div class="wrapper">
		...
		<form method="post" name ="myform" action="pend_truck.php?action=cari" class="form-horizontal" > 
		<div class="content-wrapper" style="min-height:750px">
			<br>
			<ol class="breadcrumb">
				<li><h1><i class="fa fa-list"></i><font size="4">&nbsp;&nbsp;<b>Pendapatan Truck</b></font></h1></li>					
			</ol>
			<br>
			<div class="col-md-12" >
